...
public class Utils {
    ...
    /**
     * Questa funzione è utile per poter ottenere la propria chiave pubblica dal proprio keystore.
    ...
    /**
     * Questa funzione è utile per poter ottenere la propria chiave privata dal proprio keystore.
     * @param nomeFile riferimento al keystore
     * @param password password di accesso
     * @param alias alias identificativo
     ...
     * @throws Exception
     */
    public static PrivateKey obtainPrivateFromKeystore(String nomeFile, String password, String alias)throws Exception{
        File file = new File(nomeFile);
        FileInputStream is = new FileInputStream(file);
        KeyStore keystore = KeyStore.getInstance(KeyStore.getDefaultType());
        keystore.load(is, password.toCharArray());
    ...
    /**
     * Questa funzione è utile per poter ottenere la chiave pubblica dall'alias passato come parametro nel proprio truststore.
     ...
     * @throws Exception
     */
    public static PublicKey obtainValuesFromTruststore(String nomeFile, String password, String alias)throws Exception{
        File file = new File(nomeFile);
        FileInputStream is = new FileInputStream(file);
