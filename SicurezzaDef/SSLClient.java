...
public class SSLClient
{
    ...
    static void Protocol(Socket cSock,byte[] firstSent) throws Exception{// note that the SSLSocket object is converted in a standard Socket object and henceforth we can work as for standard Java sockets
        char esito = 'c';
    ...
    static void seeAll() throws Exception{// note that the SSLSocket object is converted in a standard Socket object and henceforth we can work as for standard Java sockets
    ...
    public static void main(String[] args) throws Exception{
        ...
        SSLSocket cSock = (SSLSocket)sockfact.createSocket("localhost", 5000); // specify host and port
        ...
        //we send the public key to server just to allow to server to verify the messages send by voters
        
        /*System.out.println("questa e la lunghezza in byte delle chiavi: " + keyPair.getPublic().getEncoded().length);
        ...
        if(ClientPrivatekey != null && ClientPublickey != null && SocietyPublicKey != null){
            ...
            SSLSocket cSock2 = (SSLSocket)sockfact.createSocket("localhost", 5000); // specify host and port
